...
/*
 * this file is pulled up when an ENTRY form in the CMS is posted
 *
...
header('Content-Type: text/html; charset=utf-8');
    // configuration
        ...
        if ( $_SESSION['recipeName'] !=="" &&
            ...
            $result = query("SELECT * FROM `recipe-table` WHERE `name` = ?", ampReplace($_SESSION['recipeName']));
            ...
            // redirect where we came from with error message
